...
//
btSoftBody::btSoftBody(btSoftBodyWorldInfo*	worldInfo,int node_count,  const btVector3* x,  const btScalar* m, void * ownerPointer)
: btCollisionObject(ownerPointer), m_softBodySolver(0),m_worldInfo(worldInfo)
{	
	/* Init		*/ 
	initDefaults();
...
btSoftBody::btSoftBody(btSoftBodyWorldInfo*	worldInfo, void * ownerPointer)
: btCollisionObject(ownerPointer), m_worldInfo(worldInfo)
{
	initDefaults();
}
