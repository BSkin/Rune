...
//				printf("impulse.m_drift = %f,%f,%f\n",impulse.m_drift.getX(),impulse.m_drift.getY(),impulse.m_drift.getZ());
	...
	/* ctor																	*/ 
	btSoftBody(	btSoftBodyWorldInfo* worldInfo,int node_count,		const btVector3* x,		const btScalar* m, void * ownerPointer = 0);

	/* ctor																	*/ 
	btSoftBody(	btSoftBodyWorldInfo* worldInfo, void * ownerPointer = 0);
