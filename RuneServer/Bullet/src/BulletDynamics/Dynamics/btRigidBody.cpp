...
btRigidBody::btRigidBody(const btRigidBody::btRigidBodyConstructionInfo& constructionInfo, void * ownerPointer) : btCollisionObject(ownerPointer)
{
	setupRigidBody(constructionInfo);
}

btRigidBody::btRigidBody(btScalar mass, btMotionState *motionState, btCollisionShape *collisionShape, const btVector3 &localInertia, void * ownerPointer) : btCollisionObject(ownerPointer) 
{
